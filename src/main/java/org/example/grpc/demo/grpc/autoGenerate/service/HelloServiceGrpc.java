...
public final class HelloServiceGrpc {
  ...
  public static final String SERVICE_NAME = "org.example.grpc.demo.grpc.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<org.example.grpc.demo.grpc.autoGenerate.model.HelloRequest,
      org.example.grpc.demo.grpc.autoGenerate.model.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = org.example.grpc.demo.grpc.autoGenerate.model.HelloRequest.class,
      responseType = org.example.grpc.demo.grpc.autoGenerate.model.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.example.grpc.demo.grpc.autoGenerate.model.HelloRequest,
      org.example.grpc.demo.grpc.autoGenerate.model.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<org.example.grpc.demo.grpc.autoGenerate.model.HelloRequest, org.example.grpc.demo.grpc.autoGenerate.model.HelloResponse> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<org.example.grpc.demo.grpc.autoGenerate.model.HelloRequest, org.example.grpc.demo.grpc.autoGenerate.model.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.grpc.demo.grpc.autoGenerate.model.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.example.grpc.demo.grpc.autoGenerate.model.HelloResponse.getDefaultInstance()))
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public org.example.grpc.demo.grpc.autoGenerate.model.HelloResponse hello(org.example.grpc.demo.grpc.autoGenerate.model.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.example.grpc.demo.grpc.autoGenerate.model.HelloResponse> hello(
        org.example.grpc.demo.grpc.autoGenerate.model.HelloRequest request) {
  ...
  static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((org.example.grpc.demo.grpc.autoGenerate.model.HelloRequest) request,
              (io.grpc.stub.StreamObserver<org.example.grpc.demo.grpc.autoGenerate.model.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return org.example.grpc.demo.grpc.autoGenerate.model.Hello.getDescriptor();
    }
